...
public final class LeitoraDados {
    ...
    /**
     * Ler os dados de um cliente a ser cadastrado.
     *
    ...
    public static Caderno lerCaderno() {
        ...
        System.out.println("Digite o tipo por quantidade de matérias: M2, M5, M10");
        String tipo = lerDado();
     ...
     */
    public static Pedido lerPedido(Banco banco, Cliente clienteLogado) {
